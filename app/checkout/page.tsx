...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    console.log(`[CHECKOUT] Conectando aos eventos em tempo real: ${pixData.externalId}`)
    ...
    eventSource.onmessage = (event) => {
      try {
        ...
        console.log("[CHECKOUT] Evento recebido:", data)
        ...
        switch (data.type) {
          ...
          case "connected":
            console.log("[CHECKOUT] Conectado aos eventos em tempo real")
            break

          case "timeout":
            console.log("[CHECKOUT] Timeout da conexão de eventos")
            break
        }
      } catch (error) {
        console.error("[CHECKOUT] Erro ao processar evento:", error)
      }
    }

    eventSource.onerror = (error) => {
      console.error("[CHECKOUT] Erro na conexão de eventos:", error)
    }

    return () => {
      console.log("[CHECKOUT] Desconectando eventos em tempo real")
      eventSource.close()
    }
