...
export default function PacPaymentPage() {
      ...
      <div className="max-w-md mx-auto p-4 py-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-xl font-bold mb-2">PAC Selecionado</h1>
            <p className="text-gray-600">Entrega em 10 dias úteis</p>
          </div>

          {/* Price */}
          <div className="text-center mb-6">
            <p className="text-3xl font-bold text-black">{PAC_PRICE}</p>
