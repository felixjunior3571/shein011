...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validar estrutura do webhook SuperPay conforme exemplo fornecido
    ...
    // Extrair dados do webhook conforme estrutura real
    ...
    const pixCode = invoice.payment?.details?.pix_code
    const barcode = invoice.payment?.details?.barcode
