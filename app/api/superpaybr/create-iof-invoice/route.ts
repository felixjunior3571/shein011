...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("📋 Dados IOF recebidos:", {
      amount,
      type,
    ...
    // Criar fatura IOF SuperPayBR
    const invoiceData = {
      external_id: externalId,
      amount: Math.round(amount * 100), // R$ 21,88 em centavos
    ...
    console.log("✅ Fatura IOF SuperPayBR processada:", processedInvoice.external_id)
