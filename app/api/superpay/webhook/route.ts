...
// Mapeamento completo de status codes da SuperPay
...
export async function POST(request: NextRequest) {
  try {
    ...
    // CORREÇÃO CRÍTICA: Usar prices.total corretamente
    ...
    console.log("💰 [SuperPay Webhook] Valor processado: R$", amount)
